...
#define E2POOM_MEASUREMENTDLG_LEASER_DATA_MOD_USE				0   //显示模式默认值   0原图，1轮廓,2深度图,3点云
#define E2POOM_MEASUREMENTDLG_LEASER_DATA_MOD_MAX				3   //显示模式最大值
...
/****************************/
    //主页面参数
    Int8 measurementDlg_leaser_data_mod;  //显示模式，0原图，1轮廓,2深度图,3点云
